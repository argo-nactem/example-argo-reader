...
import uk.ac.nactem.argo.example.ExampleReader;
 ...
 */
public class ExampleReaderTest {
	...
	public void setup() throws ResourceInitializationException, FileNotFoundException {
		...
		reader = createReaderDescription(ExampleReader.class, ExampleReader.PARAM_FILE_DIRECTORY, dir);
